<div class="container">
    ...
    <div class="card" style="margin-left: 20px">
        <div class="photo">
            <a href="http://localhost:5173/integrations/socioeconomics-tracker-using-unconventional-data"><img src = "data:image/jpeg;=" alt="Imagen" style="width: 330px; margin-top: 80px; margin-bottom:10px;"></a>
        </div>
